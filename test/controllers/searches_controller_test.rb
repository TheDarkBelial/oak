...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  test "should not return results without a query" do
    ...
    assert_select "turbo-frame#search > ul > li", count: 0
  end
  ...
  test "should return results with a query that has multiple matches" do
    ...
    assert_response :success
    assert_select "turbo-frame#search > ul > li", count: 3
  end
  ...
  test "should return results with a query that has just application matches" do
    ...
    assert_response :success
    assert_select "turbo-frame#search > ul > li", count: 1
    assert_select "turbo-frame#search > ul > li > a[href=?]", "https://unifi/login"
  end
  ...
  test "should return results with a query that has just bookmark matches" do
    ...
    assert_response :success
    assert_select "turbo-frame#search > ul > li", count: 1
    assert_select "turbo-frame#search > ul > li > a[href=?]", "https://www.ruby-lang.org"
  end
end
